...
import "./Truck.css";
import smartTrucksVideo from "../../../assets/Products/Smart Trucks/smarttrucks.mp4";
import truck1Image from "../../../assets/Products/Smart Trucks/truck 1.jpg";
import truck2Image from "../../../assets/Products/Smart Trucks/truck 2.jpeg";
import truck3Image from "../../../assets/Products/Smart Trucks/truck 3.jpg";
      ...
      <section className="truck-hero">
        <div className="video-overlay">
          <video 
            ...
            playsInline
          >
            <source src={smartTrucksVideo} type="video/mp4" />
        ...
        <div className="benefits-container">
          <div className="benefit-card">
            <div className="benefit-image">
              <img src={truck1Image} alt="24x7 Support" />
            </div>
          ...
          <div className="benefit-card">
            <div className="benefit-image">
              <img src={truck2Image} alt="Flexible System" />
            </div>
            <div className="benefit-content">
              <div className="heading-with-icon">
